...
class CB_Map_Filter {
  ...
  **/
  public static function filter_locations_by_timeframes_and_categories($locations, $cb_map_id, $preset_categories = []) {
    ...
    $preset_category_groups = []; //CB_Map::get_cb_items_category_groups($preset_categories); //TODO: CB2 cb_items categories?
    ...
    foreach ($timeframes as $timeframe) {
      ...
      if($is_valid_item) {
        ...
        if(isset($locations[$location_id])) {
          ...
          //$cb_data = new CB_Data(); //TODO: CB2 daystoshow replacement?
          /*
