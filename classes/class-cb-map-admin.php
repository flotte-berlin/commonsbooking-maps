...
class CB_Map_Admin {
  ...
  public static function add_meta_boxes() {
    self::add_settings_meta_box('cb_map_admin', cb_map\__( 'CB_MAP_ADMIN_METABOX_TITLE', 'commonsbooking-maps', 'Map Configuration'));
  }
  ...
  **/
  public static function validate_options($cb_map_id) {
    ...
    $validated_input['custom_no_locations_message'] = isset($input['custom_no_locations_message']) ? sanitize_text_field($input['custom_no_locations_message']) : $validated_input['custom_no_locations_message'];
  ...
  **/
  ...
  public static function render_options_page($post) {
    ...
    //map translation
    $translation = [
      'SELECT_IMAGE' => cb_map\__('SELECT_IMAGE', 'commonsbooking-maps', 'Select an image'),
      'SAVE' => cb_map\__('SAVE', 'commonsbooking-maps', 'save'),
