...
class CB_Map {
  ...
  **/
  public static function register_cb_map_post_type() {
    $labels = array(
      'name'                  => cb_map\__( 'POST_LABELS_NAME', 'commonsbooking-maps', 'CommonsBooking maps'),
      'singular_name'         => cb_map\__( 'POST_LABELS_SINGULAR_NAME', 'commonsbooking-maps', 'CommonsBooking map'),
      'add_new'               => cb_map\__( 'POST_LABELS_ADD_NEW', 'commonsbooking-maps', 'create CB map'),
      'add_new_item'          => cb_map\__( 'POST_LABELS_ADD_NEW_ITEM', 'commonsbooking-maps', 'create CommonsBooking map'),
      'edit_item'             => cb_map\__( 'POST_LABELS_EDIT_ITEM', 'commonsbooking-maps', 'edit CommonsBooking map'),
      'new_item'              => cb_map\__( 'POST_LABELS_NEW_ITEM', 'commonsbooking-maps', 'create CB map'),
      'view_item'             => cb_map\__( 'POST_LABELS_VIEW_ITEM', 'commonsbooking-maps', 'view CB map'),
      'search_items'          => cb_map\__( 'POST_LABELS_SEARCH_ITEMS', 'commonsbooking-maps', 'search CB maps'),
      'not_found'             => cb_map\__( 'POST_LABELS_NOT_FOUND', 'commonsbooking-maps', 'no CommonsBooking map found'),
      'not_found_in_trash'    => cb_map\__( 'POST_LABELS_NOT_FOUND_IN_TRASH', 'commonsbooking-maps', 'no CommonsBooking map found in the trash'),
      'parent_item_colon'     => cb_map\__( 'POST_LABELS_PARENT_ITEM_COLON', 'commonsbooking-maps', 'parent CB maps'),
    );
    ...
    $args = array(
      'labels' => $labels,
      'hierarchical' => true,
      'description' => cb_map\__( 'POST_TYPE_DESCRIPTION', 'commonsbooking-maps', 'Maps to show Commons Booking Locations and their Items'),
      'supports' => $supports,
      'public' => false,
      'show_ui' => true,
      'show_in_menu' => false,
  ...
  public static function admin_menu() {
    $name = cb_map\__( 'MAPS', 'commonsbooking-maps', 'maps');
    add_submenu_page('cb-dashboard', $name, $name, 'manage_options', 'edit.php?post_type=cb_map', '');
  }
