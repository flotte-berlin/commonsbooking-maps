...
class CB_Map_Settings {
  ...
  **/
  public function prepare_settings() {
    ...
    add_action('admin_menu', function() {
        add_options_page( cb_map\__('SETTINGS_TITLE', 'commonsbooking-maps', 'Settings for CommonsBooking Maps'), cb_map\__('SETTINGS_MENU', 'commonsbooking-maps', 'CommonsBooking Maps' ), 'manage_options', 'commonsbooking-maps', array($this, 'render_settings_page') );
    });
  ...
  **/
  public function add_settings_link( $links ) {
    $settings_link = '<a href="options-general.php?page=commonsbooking-maps">' . __( 'Settings') . '</a>';
